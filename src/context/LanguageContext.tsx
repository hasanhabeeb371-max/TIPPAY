...
const translations: TranslationDictionary = {
  ...
  "home.seeMore": { en: "See more", hi: "और देखें", kn: "ಇನ್ನಷ್ಟು ನೋಡಿ", es: "Ver más", ar: "عرض المزيد" },
  "home.allCategories": { en: "All Categories", hi: "सभी श्रेणियाँ", kn: "ಎಲ್ಲಾ ವರ್ಗಗಳು", es: "Todas las categorías", ar: "جميع الفئات" },
  "home.orderStatus": { en: "Your orders", hi: "आपके ऑर्डर", kn: "ನಿಮ್ಮ ಆರ್ಡರ್‌ಗಳು", es: "Tus pedidos", ar: "طلباتك" },
