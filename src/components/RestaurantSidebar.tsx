import { ClipboardList, UtensilsCrossed, BarChart3, LogOut, Store, Ticket, Sparkles } from "lucide-react";
...
const items = [
  ...
  { title: "Dish Requests", url: "/restaurant/dashboard/requests", icon: Sparkles },
